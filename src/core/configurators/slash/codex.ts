...
const FILE_PATHS: Record<SlashCommandId, string> = {
  proposal: ".codex/prompts/spectest-proposal.md",
  apply: ".codex/prompts/spectest-apply.md",
  archive: ".codex/prompts/spectest-archive.md",
};
...
argument-hint: request or test feature description
---
