...
export const VALIDATION_MESSAGES = {
  ...
  GUIDE_NO_DELTAS:
    'No deltas found. Ensure your change has a specs/ directory with test capability folders (e.g. specs/login-tests/spec.md) containing .md files that use delta headers (## ADDED/MODIFIED/REMOVED/RENAMED Requirements) and that each requirement includes at least one "#### Scenario:" block. Tip: run "spectest change show <change-id> --json --deltas-only" to inspect parsed deltas.',
