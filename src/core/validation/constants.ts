...
export const VALIDATION_MESSAGES = {
  ...
  GUIDE_NO_DELTAS:
    'No deltas found. Ensure your change has a specs/ directory with test capability folders (e.g. specs/login-tests/spec.md) containing .md files that use delta headers (## ADDED/MODIFIED/REMOVED/RENAMED Requirements) and that each test requirement includes at least one "#### Scenario:" block. Tip: run "spectest change show <change-id> --json --deltas-only" to inspect parsed deltas.',
  GUIDE_MISSING_SPEC_SECTIONS:
    'Missing required sections. Expected headers: "## Purpose" and "## Requirements". Example:\n## Purpose\n[brief test purpose]\n\n## Requirements\n### Requirement: Clear test requirement statement\nThe test suite SHALL ...\n\n#### Scenario: Descriptive test scenario name\n- **WHEN** ...\n- **THEN** ...',
