...
program
  .command('init [path]')
  .description('Initialize SpecTest in your project')
...
program
  .command('update [path]')
  .description('Update SpecTest instruction files')
...
changeCmd.hook('preAction', () => {
  console.error('Warning: The "spectest change ..." commands are deprecated. Prefer verb-first commands (e.g., "spectest list", "spectest validate --changes").');
});
...
changeCmd
  ...
  .action(async (options?: { json?: boolean; long?: boolean }) => {
    try {
      console.error('Warning: "spectest change list" is deprecated. Use "spectest list".');
      const changeCommand = new ChangeCommand();
...
program
  ...
  .option('--concurrency <n>', 'Max concurrent validations (defaults to env SPECTEST_CONCURRENCY or 6)')
  .option('--no-interactive', 'Disable interactive prompts')
...
const completionCmd = program
  .command('completion')
  .description('Manage shell completions for SpecTest CLI');
