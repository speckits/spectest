  ...
  describe('generate', () => {
    it('should generate valid zsh completion script with header', () => {
      const commands: CommandDefinition[] = [
        {
          name: 'init',
          description: 'Initialize SpecTest',
          flags: [],
        },
      ];
      ...
      expect(script).toContain('#compdef spectest');
      expect(script).toContain('# Zsh completion script for SpecTest CLI');
      expect(script).toContain('_spectest() {');
    });
    ...
    it('should include all commands in the command list', () => {
      ...
      expect(script).toContain("'init:Initialize SpecTest'");
    ...
    it('should generate command completion functions', () => {
      ...
      expect(script).toContain('_spectest_init() {');
      expect(script).toContain('_spectest_validate() {');
    });
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain('_spectest_change_show() {');
      expect(script).toContain('_spectest_change_list() {');
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain("'*: :_spectest_complete_changes'");
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain("'*: :_spectest_complete_specs'");
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain("'*: :_spectest_complete_items'");
    });
    ...
    it('should sanitize command names with hyphens for function names', () => {
      ...
      expect(script).toContain('_spectest_my_command() {');
    });
    ...
    it('should handle complex nested subcommands with flags', () => {
      ...
      expect(script).toContain('_spectest_spec() {');
      expect(script).toContain('_spectest_spec_validate() {');
      expect(script).toContain('--strict');
      expect(script).toContain('--json');
      expect(script).toContain("'*: :_spectest_complete_specs'");
    });
    ...
    it('should generate script that ends with compdef registration', () => {
      ...
      expect(script.trim().endsWith('compdef _spectest spectest')).toBe(true);
    });
    ...
    it('should handle commands with no flags', () => {
      ...
      expect(script).toContain('_spectest_view() {');
