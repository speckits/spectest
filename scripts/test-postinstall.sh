...
echo "======================================"
echo "Testing SpecTest Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_SPECTEST_NO_COMPLETIONS="${SPECTEST_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should attempt to install completions)"
echo "--------------------------------------"
unset CI
unset SPECTEST_NO_COMPLETIONS
...
echo "Test 3: SPECTEST_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export SPECTEST_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_SPECTEST_NO_COMPLETIONS" ]; then
  export SPECTEST_NO_COMPLETIONS="$ORIGINAL_SPECTEST_NO_COMPLETIONS"
else
  unset SPECTEST_NO_COMPLETIONS
fi
